...
$proxy->config_proxy_list('test',"http://bpteam.net",array("#\+380632359213#ims",'#bpteam22@gmail.com#ims'),array('anonim','cookie','referer'),true);//Меняем требования к прокси
