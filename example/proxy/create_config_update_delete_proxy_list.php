...
$proxy->config_proxy_list('test',"http://bpteam.net",array("#\+380632359213#ims",'#bpteam22@gmail.com#ims'),array('anonym' => 1,'cookie' => 1,'referer' => 1),true);//Меняем требования к прокси
