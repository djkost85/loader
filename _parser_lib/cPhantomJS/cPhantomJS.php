...
class cPhantomJS {
	...
	public function screenShotFromUrl($url, $width = 600, $height = 600){
		$this->setArguments(array($url, $width, $height));
	...
	public function test(){
		...
		echo $this->screenShotFromUrl('http://google.com', 1024, 768);
	}
} 