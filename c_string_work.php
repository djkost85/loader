...
class c_string_work
{
	private $cript_tag_array;//Массив с тегами и хеш кодами для обработки через синонимайзер или переводчик, чтоб не потерять HTML теги. $cript_tag_array['tag'] - набор тегов $cript_tag_array['hash'] - набор хешей. Порядок тегов и хешей соответстует их значению в строке.
	private $divided_text_array;//Массив разбитого текста для обработки через синонимайзер или переводчик
...
public static function between_tag($text="",$start_tag='<div class="xxx">',$without_tag=1)
{
	$count=0;
